This is a simple Dietary Reference Intakes(DRIs) Calculator that users can interact with. The user can choose different buttons from the main menu, including:
